    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary" href="{{ route('author.post.create') }}">Add New Post</a>
            </div>
            <!-- Exportable Table -->
                                        ...
                                        @foreach($posts as $key=>$post)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-success waves-effect" href="{{ route('author.post.show',$post->id) }}"><i class="material-icons">visibility</i></a>


                                                    <a class="btn btn-info waves-effect" href="{{ route('author.post.edit',$post->id) }}"><i class="material-icons">border_color</i></a>
